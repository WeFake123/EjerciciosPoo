...
Pueden encontrar un ejemplo para descargar de vector en el
GIT de tu Curso.
 */
package ejercicioextra06pooahorcado;

import Entidad.Entidad;
import java.util.Scanner;
import servicios.Servicio;

public class EjercicioExtra06POOahorcado {
    public static void main(String[] args) {
        Scanner leer = new Scanner(System.in);
        Servicio s = new Servicio();
        Entidad juego = s.crearJuego();
